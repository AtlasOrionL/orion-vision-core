...
exports.OrionMobilePreview = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const logger_1 = require("../utils/logger");
class OrionMobilePreview {
    constructor(config) {
        this.devices = [
            {
                name: 'iPhone 14 Pro',
    ...
    async showPreview() {
        try {
            ...
            if (this.previewPanel) {
                ...
                this.previewPanel = vscode.window.createWebviewPanel('orionMobilePreview', `📱 Mobile Preview - ${selectedDevice.name}`, vscode.ViewColumn.Two, {
                    enableScripts: true,
    ...
    async generatePreviewContent(filePath, device) {
    ...
    setupAutoRefresh(document, device) {
...
exports.OrionMobilePreview = OrionMobilePreview;
//# sourceMappingURL=mobilePreviewProvider.js.map