...
exports.OrionDeploymentManager = void 0;
...
class OrionDeploymentManager {
    ...
    async showDeploymentPanel() {
        if (this.deploymentPanel) {
            this.deploymentPanel.reveal(vscode.ViewColumn.Two);
            return;
        }
        this.deploymentPanel = vscode.window.createWebviewPanel('orionDeployment', '🚀 Orion Deployment', vscode.ViewColumn.Two, {
            enableScripts: true,
        ...
        this.deploymentPanel.webview.onDidReceiveMessage(message => this.handleWebviewMessage(message), undefined);
        // Generate deployment interface
        this.deploymentPanel.webview.html = this.getDeploymentInterfaceHtml();
    }
    getDeploymentInterfaceHtml() {
        return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
    ...
    async simulateDeployment(deployment, target) {
        const steps = [
        ...
        vscode.window.showInformationMessage(`🚀 Deployment to ${target.name} completed successfully in ${Math.round(deploymentTime / 1000)}s`);
    }
...
exports.OrionDeploymentManager = OrionDeploymentManager;
//# sourceMappingURL=deploymentProvider.js.map