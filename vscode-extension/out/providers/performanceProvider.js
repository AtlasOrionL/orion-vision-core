...
exports.OrionPerformanceMonitor = void 0;
const vscode = __importStar(require("vscode"));
const os = __importStar(require("os"));
const logger_1 = require("../utils/logger");
class OrionPerformanceMonitor {
    constructor(config) {
    ...
    async showInsights() {
        try {
            ...
            if (this.insightsPanel) {
                ...
                this.insightsPanel = vscode.window.createWebviewPanel('orionPerformanceInsights', '📊 Orion Performance Insights', vscode.ViewColumn.Two, {
                    enableScripts: true,
                ...
                this.insightsPanel.webview.onDidReceiveMessage(message => this.handleWebviewMessage(message), undefined);
            }
    ...
    async getInsightsInterfaceHtml() {
    ...
    generateRecommendations(metrics, codeMetrics) {
...
exports.OrionPerformanceMonitor = OrionPerformanceMonitor;
