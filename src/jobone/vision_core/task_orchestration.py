...
class TaskScheduler:
    ...
    def __init__(self, discovery_manager: Optional[ServiceDiscoveryManager] = None):
        ...
        # Task management attributes (for API compatibility)
        self.tasks = {
    ...
    def schedule_task(self, task_definition: TaskDefinition) -> bool:
        """
        Schedule a task (alias for submit_task for API compatibility)

        Args:
            task_definition: Task definition to schedule
    ...
    def list_tasks(self) -> Dict[str, List[str]]:
        ...
        Returns:
            Dict with task lists by status
        """
        return {
