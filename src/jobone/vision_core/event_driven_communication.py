...
from .agents.communication_agent import OrionMessage, MessageType, MessagePriority
...
class EventDrivenCommunication(EventDrivenCommunicationManager):
    """
...
if __name__ == "__main__":
    ...
    async def test_event_communication():
        manager = EventDrivenCommunicationManager("test_agent")
        ...
        await manager.publish_event(test_event)
    ...
    asyncio.run(test_event_communication())
