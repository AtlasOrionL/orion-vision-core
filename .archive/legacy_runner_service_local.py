...
This is a duplicate of the active version in src/jobone/vision_core/runner_service.py

For the current, maintained version, use: src/jobone/vision_core/runner_service.py
Active symlink: local-deployment/python-core/src/runner_service.py -> ../../../src/jobone/vision_core/runner_service.py
"""
